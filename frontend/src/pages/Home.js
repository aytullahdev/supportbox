  ...
  return (
    <div className=" font-bold text-center py-10">
      ...
      <div className="flex flex-col space-y-5">
        <button className="flex text-xl justify-center items-center font-normal space-x-5 border border-1 border-gray-600 p-2 w-2/3 lg:w-1/3 mx-auto  cursor-pointer hover:bg-slate-300">
